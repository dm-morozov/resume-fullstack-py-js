...
# Какое значение будет в переменной product? - None, так как ключа 3 нет, есть только 1 and 2
# Запретит ли сам Python вызвать find_product("1", products)? - нет, так как анотация для программиста и ide. Вообщем для удобства, но не для интерпретатора Python
